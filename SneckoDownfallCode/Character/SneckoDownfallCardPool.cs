...
public class SneckoDownfallCardPool : CustomCardPoolModel
{
    public override string Title => SneckoDownfall.CharacterId; //This is not a display name.
    ...
    {
        //This will attempt to load SneckoDownfall/images/cards/frame.png
